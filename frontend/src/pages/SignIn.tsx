 ...
 * Sign In Page
 * 
 * Google Sign-In only - redirects existing users to dashboard.
 * Prompts non-existing users to sign up first.
 */
...
const SignIn = () => {
  ...
  // Get redirect destination (where user was trying to go)
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.isNewUser) {
          setError("You don't have a Lently account yet. Please sign up first.");
        } else {
